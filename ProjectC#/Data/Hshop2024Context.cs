...
namespace ProjectC_.Data;

public partial class Hshop2024Context : DbContext
{
    public Hshop2024Context()
    {
    }

    public Hshop2024Context(DbContextOptions<Hshop2024Context> options)
        : base(options)
    {
    }
