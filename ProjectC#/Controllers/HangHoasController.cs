...
namespace ProjectC_.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(Hshop2024Context context)
        {
            _context = context;
        }
        ...
        {
            var hshop2024Context = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await hshop2024Context.ToListAsync());
        }
